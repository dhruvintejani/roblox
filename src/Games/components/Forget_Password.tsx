  ...
  return (
    <div>
      <div className="flex items-center justify-center bg-gradient-to-br">
        ...
        >
          <h2 className="text-3xl font-bold text-center text-gray-800 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
            Reset Password
          </h2>
          ...
          <div className="flex">
          <p className="">Remembered your Password?</p> &nbsp;
          <Link to={'/'} className="text-red-600 hover:underline">Log in</Link>
        </div>
